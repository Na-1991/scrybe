...
const ContactUs = ({className}: Props) => {
  return (
    <div id='contact-us' className={cn(className,'min-h-[300px]')}>
           <Heading title='Contact Us' description='Have a project? Let us help you build trust, educate your audience, and stand out across platforms and markets.' descriptionClass='text-md text-muted'/>
